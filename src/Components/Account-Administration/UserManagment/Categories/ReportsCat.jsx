...
export default function ReportsCat(props) {
  const dispatch = useDispatch();
  const reports = useSelector((state) => state.PermissionCustomers.reports);
  const ARMReports = useSelector((state) => state.PermissionCustomers.armanagementreports);
  const managementreports = useSelector((state) => state.PermissionCustomers.managementreports);
  const reportbuilder = useSelector((state) => state.PermissionCustomers.reportbuilder);
    ...
    <div className="">
      <div className="col-md-12 d-flex">
        ...
        <div className="col-md-5 mt-1">
          <select
            onChange={(e) => props.reportsReports(e.target.value)}
            disabled={props.permissionStatus}
            className="form-select form-select-sm"
            name="ReportsReports"
            id="ReportsReports"
          >
            <option value="Reports Reports Deny">Deny </option>
            <option value="Reports Reports Allowed Reports Only">Allowed Reports Only</option>
      ...
      <div className="col-md-12 d-flex">
        ...
        <div className="col-md-5 mt-1">
          <select
            onChange={(e) => props.reportsArMgmntReports(e.target.value)}
            disabled={props.permissionStatus}
            className="form-select form-select-sm"
            name="ReportsA/R ManagementReports"
            id="ReportsA/R ManagementReports"
          >
            <option value="Reports A/R Management Reports Deny">Deny </option>
            <option value="Reports A/R Management Reports Allowed Reports Only">Allowed Reports Only</option>
      ...
      <div className="col-md-12 d-flex">
        ...
        <div className="col-md-5 mt-1">
          <select
            onChange={(e) => props.reportMngmntReports(e.target.value)}
            disabled={props.permissionStatus}
            className="form-select form-select-sm"
            name="ReportsManagementReports"
            id="ReportsManagementReports"
          >
            <option value="Reports Management Reports Deny">Deny </option>
            <option value="Reports Management Reports Allowed Reports Only">Allowed Reports Only</option>
      ...
      <div className="col-md-12 d-flex">
        ...
        <div className="col-md-5 mt-1">
          <select
            onChange={(e) => props.reportReportsBuilder(e.target.value)}
            disabled={props.permissionStatus}
            className="form-select form-select-sm"
            name="ReportsReportBuilder"
            id="ReportsReportBuilder"
          >
            <option value="Reports Report Builder Deny">Deny </option>
            <option value="Reports Report Builder Build and Edit Reports">Build and Edit Reports</option>
          </select>
        </div>
        <div className="col-md-2 mt-1 px-2">
