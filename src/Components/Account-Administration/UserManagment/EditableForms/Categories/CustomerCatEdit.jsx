...
const CustomerCatEdit = (props) => {
  ...
  const facility = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupfacility);
  const practice = useSelector((state) => state.EditUser?.edituserpermission?.customerSetuppractice);
  const provider = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupprovider);
  const referring = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupreferringprovider);
  const payer = useSelector((state) => state.EditUser?.edituserpermission?.customerSetuppayer);
  const payeragreement = useSelector((state) => state.EditUser?.edituserpermission?.customerSetuppayeraggrement);
  const codes = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupcodes);
  const inventory = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupinventory);
  const feeschedules = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupfeeshedule);
  const contractmanagement = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupcontractManagement);
  const alertcontrol = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupalertcontrol);
  const statementautomation = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupstatementAutomation);
  const labelandsuperbillconfig = useSelector((state) => state.EditUser?.edituserpermission?.customerSetuplabelAndSuperBill);
  const piissncustomer = useSelector((state) => state.EditUser?.edituserpermission?.customerSetuppersonalIdnSsn);
  const accountsetupcustomer = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupAccount);
  const billpaymentcustomer = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupbillPatment);
  const customization = useSelector((state) => state.EditUser?.edituserpermission?.customerSetupcustomization);
  //useState are defined here
  const [practiceState, setpracticeState] = useState('');
  const [facilityState, setfacilityState] = useState('');
  console.log("facility",facilityState);
