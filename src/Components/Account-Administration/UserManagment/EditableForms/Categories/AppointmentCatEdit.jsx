...
const AppointmentCatEdit = (props) => {
  ...
  const scheduler = useSelector((state) => state.EditUser?.edituserpermission?.appointmentsScheduler);
  const schedulerconfiguration = useSelector((state) => state.EditUser?.edituserpermission?.AppointmentsSchedulerConfiguration);
  const appointmentcontrol = useSelector((state) => state.EditUser?.edituserpermission?.appointmentControl);
  const batchprinting = useSelector((state) => state.EditUser?.edituserpermission?.appointmentBatchPrinting);
  const department = useSelector((state) => state.EditUser?.edituserpermission?.appointmentsDepartment);
  const patient_payments = useSelector((state) => state.EditUser?.edituserpermission?.appointmentsPatientPayments);
  const patientactivityappointments = useSelector((state) => state.EditUser?.edituserpermission?.appointmentsPatientActivity);
  ...
  return (
    <div className="">
      <div className="col-md-12 d-flex">
        ...
        <div className="col-md-5 mt-1">
          ...
          >
            ...
            selected ={schedulerState =="Appointments Scheduler Deny" }
            >Deny </option>
      ...
      <div className="col-md-12 d-flex">
        ...
        <div className="col-md-5 mt-1">
          {schedulerconfigurationState?<select
        ...
        <div className="col-md-5 mt-1">
         {departmentState? <select
          ...
          >
            ...
            selected={department=="Appointments Department Access, Modify, and Create"}
      ...
      <div className="col-md-12 d-flex">
        ...
        <div className="col-md-5 mt-1">
          {patientactivityappointmentState?<select
