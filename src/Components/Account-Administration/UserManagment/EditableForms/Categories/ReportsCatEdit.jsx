...
export default function ReportsCatEdit(props) {
  ...
  const reports = useSelector((state) => state.EditUser?.edituserpermission?.reportsReports);
  const ARMReports = useSelector((state) => state.EditUser?.edituserpermission?.reportsARManagement);
  const managementreports = useSelector((state) => state.EditUser?.edituserpermission?.reportsmanagementreports);
  const reportbuilder = useSelector((state) => state.EditUser?.edituserpermission?.reportbuilder);
