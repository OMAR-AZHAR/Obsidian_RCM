...
export default function PatientCatEdit(props) {
  ...
  const patient = useSelector((state) => state.EditUser?.edituserpermission?.patientPatient);
  const addressverification = useSelector((state) => state.EditUser?.edituserpermission?.PatientAddressVerification);
  const batcheligibility = useSelector((state) => state.EditUser?.edituserpermission?.patientBatchEligibility);
  const batchprinting = useSelector((state) => state.EditUser?.edituserpermission?.patientBatchPrinting);
  const controlpatient = useSelector((state) => state.EditUser?.edituserpermission?.patientControl);
  const debitpatient = useSelector((state) => state.EditUser?.edituserpermission?.patientDebitPatient);
  const editnotes = useSelector((state) => state.EditUser?.edituserpermission?.patientEditNotes);
  const eligibilitypatient = useSelector((state) => state.EditUser?.edituserpermission?.patientEligibilityDeny);
  const enhancedstatementprinting = useSelector((state) => state.EditUser?.edituserpermission?.patientEnhancedStatement);
  const patientaccountmanagement = useSelector((state) => state.EditUser?.edituserpermission?.patientPatientAccount);
  const patientactivitypatient = useSelector((state) => state.EditUser?.edituserpermission?.patientPatientActivity);
  const patientmerge = useSelector((state) => state.EditUser?.edituserpermission?.patientPatientMerge);
  const patientnotes = useSelector((state) => state.EditUser?.edituserpermission?.patientPatientNotes);
  const patientpaymentspatient = useSelector((state) => state.EditUser?.edituserpermission?.patientpaymentspatient);
  const patientportalinvite = useSelector((state) => state.EditUser?.edituserpermission?.patientPaymentPortalInvite);
  const piissnpatient = useSelector((state) => state.EditUser?.edituserpermission?.patientIdnSSN);
  const trackingpatient = useSelector((state) => state.EditUser?.edituserpermission?.patientTracking);
