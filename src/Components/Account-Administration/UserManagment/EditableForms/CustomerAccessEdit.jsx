...
import CustomerAccessEditTable from './Categories/CustomerAccessEditTable'


const CustomerAccessEdit = () => {
  return (
...
export default CustomerAccessEdit;
