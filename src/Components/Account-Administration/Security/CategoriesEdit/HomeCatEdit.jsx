...
export default function HomeCatEdit(props) {
  ...
  const dashboard = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.homeDashboard);
  const messaging = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.homeMessaging);
  const contacts = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.homeContacts);
  const administertasks = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.homeAdministerTasks);
