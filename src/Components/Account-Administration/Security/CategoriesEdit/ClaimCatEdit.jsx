...
const ClaimCatEdit = (props) => {
  ...
  // get values from permissions
  const professionalClaim = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.claimProfessional);
  const institutionalClaim = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.claimInstitutional);
  const bacthprintng = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.claimBatchPrinting);
  const claimfollowup = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.claimFollowup);
  const clearinghousereports = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.claimClearinghousereports);
  const controlclaim = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.claimControl);
  const nyworkerscompform = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.claimNyworkersCompForm);
  const patientactivityclaim = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.climPatientActivity);
  const patientpaymentclaim = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.climPatientPayment);
  const trackingclaim = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.claimTracking);
