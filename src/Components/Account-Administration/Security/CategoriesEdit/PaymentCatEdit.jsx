...
export default function PaymentCatEdit(props) {
  ...
  const patient_payments = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.paymentsPatient);
  const insurancepayments = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.paymentsInsurance);
  const eraautoapply = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.PaymentEraAutoApply);
  const patientactivitypayment = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.paymentPatientactivity);
  const trackingpayments = useSelector((state) => state.ShowAllRolesSlice.editPermissionData.paymentsTracking);
  ...
  useEffect(() => {
    ...
    patient_payments,insurancepayments,eraautoapply,patientactivitypayment,trackingpaymentsState
