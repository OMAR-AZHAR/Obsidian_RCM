...
import { setSupervisingProviderData } from "../../../Redux/features/Claim/ClaimAddNewSlice";
const supervisingProv = [
  {
    ref: "",
    npi: 2452525,
...
const SuperVisingProviderModel = () => {
  const dispatch = useDispatch();
  const getSupervisingProviderName = e => {
    dispatch(setSupervisingProviderData(e));
  };
  return (
    <div
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <table className="table table-light table-hover table-striped table table-bordered">
              ...
              <tbody>
                {supervisingProv.map((provi, i) => (
                  <tr
                    key={i}
                    data-bs-dismiss="modal"
                    onClick={() => getSupervisingProviderName(provi.name)}
                  >
                    <td>{provi.ref}</td>
                    <td>{provi.npi}</td>
                    <td>{provi.name}</td>
...
export default SuperVisingProviderModel;
