...
const SecondaryInsuranceModel = () => {
  const dispatch = useDispatch();
  const getSecInsuranceProviderName = e => {
    dispatch(setSecInsuranceProviderData(e));
    dispatch(setToggleSecondaryDetails(true));
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <table className="table table-light table-hover table-striped table table-bordered">
              ...
              <tbody>
                {secondaryInsDetails.map((provi, i) => (
                  <tr
                    key={i}
                    data-bs-dismiss="modal"
                    onClick={() => getSecInsuranceProviderName(provi.payerName)}
                  >
...
export default SecondaryInsuranceModel;
