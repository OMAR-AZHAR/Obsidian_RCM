...
import { setSalesRepProviderData } from "../../../Redux/features/Claim/ClaimAddNewSlice";
const salesRepProv = [
  {
...
const SalesRepModel = () => {
  ...
  const getSalesRepProviderName = e => {
    dispatch(setSalesRepProviderData(e));
  };
  return (
    <div
      className="modal fade"
      id="salesRep_providerModal"
        ...
        <div className="modal-content">
          ...
          <div className="modal-body">
            ...
            <table className="table table-light table-hover table-striped table table-bordered">
              ...
              <tbody>
                {salesRepProv.map((provi, i) => (
                  <tr
                    key={i}
                    data-bs-dismiss="modal"
                    onClick={() => getSalesRepProviderName(provi.name)}
                  >
                    <td>{provi.name}</td>
