...
const IcdProcedureShowAllModal = () => {
  return (
    <div
      ...
      <div className="modal-dialog modal-dialog-scrollable modal-dialog-centered">
        <div className="modal-content">
          <div className="modal-header">
            <h5 className="modal-title" id="showicdProcedureModal">
          ...
          <div className="modal-body">
            <div className="input-group input-group-sm">
              <input
                ...
                id="showallmodalicdProcedurecode"
                name="showallmodalicdProcedurecode"
...
export default IcdProcedureShowAllModal;
