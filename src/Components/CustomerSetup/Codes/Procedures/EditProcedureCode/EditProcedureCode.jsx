...
const EditProcedureCode = () => {
  ...
  const [excludeCode, setExcludceCode] = useState("");
  const [includeCode, setInccludceCode] = useState("");
  const [codePercentage, setCodePercentage] = useState("");
  const excludeCodevalue = excludeCode;
  const includeCodevalue = includeCode;
  const codePercentagevalue = codePercentage;
  ...
  const [posId, setPosId] = useState(posCode);
  ...
  const [printSuperbillCode, setPrintSuperbillCode] = useState("");
  ...
  useEffect(() => {
    API.get(`customersetup/code/procedure/edit/${id}`).then((res) => {
      const procedureCode = res.data.data;
      setCode(procedureCode?.procedure_code);
      settype(procedureCode?.procedure_type);
      setDept(procedureCode?.dept);
      setProcedureDescription(procedureCode?.description);
      setExcludceCode(procedureCode?.exclude_duplicate);
      setInccludceCode(procedureCode?.inclusive_code);
      setCodePercentage(procedureCode?.default_percentage);
      setDefaultPrice(procedureCode?.default_price);
      setDefaultUnits(procedureCode?.default_units);
      setDefaultChargeStatus(procedureCode?.default_charge_status);
      // setRevenueCode(procedureCode?.revenue_codes_id);
      setSendRevCOde(procedureCode?.revenue_codes_id);
      // setRevenueCode(procedureCode);
      setSendPOSCodes(procedureCode?.pos_id);
      setPosId(procedureCode?.pos_id);
      setCLiaNum(procedureCode?.clia_num);
      setSendTOSCodes(procedureCode?.tos_id);
      setNarrativeNotes(procedureCode?.narrative_notes);
      setSendModifer1Code(procedureCode?.global_modifier_id1);
      setSendModifer2Code(procedureCode?.global_modifier_id2);
      setSendModifer3Code(procedureCode?.global_modifier_id3);
      setSendModifer4Code(procedureCode?.global_modifier_id4);
      setDrugPrice(procedureCode?.drug_price);
      setDrugUnit(procedureCode?.drug_unit);
      sedDrugUnitMeasure(procedureCode?.drug_unit_measure);
      setDrugCode(procedureCode?.drug_code);
      setDrugCodeFormat(procedureCode?.drug_code_format);
      setAddDescription(procedureCode?.add_description);
      setGlobalPeriod(procedureCode?.global_period);
      setEffectiveDate(procedureCode?.effective_date);
      setTerminationDate(procedureCode?.termination_date);
      setPrintSuperbillCode(procedureCode?.print_category);
      setSuperBillDescription(procedureCode?.print_description);
      setStatementDescription(procedureCode?.statement_description);
    });
  ...
  onSubmit: (values, action) => {
    // values from hooks  `customersetup/code/procedure/edit/${id}`
    // -API.post("customersetup/code/procedure/store", {
    // API.put(`customersetup/code/procedure/store/${id}`, {
    //   code: code,
    //   type: type,
    //   dept: dept,
    ...
    //   codePercentage: codePercentagevalue,
    ...
    //   revenueCode: revenueCodes,
    //   posId: posId ? Number(posId) : "",
    //   cliaNum: Number(cliaNum),
    //   tosId: tosId ? Number(tosId) : "",
      ...
      <div className="row mt-4">
        <form action="post">
          <div className="d-flex">
            ...
            >
              <div className="">
                <h3 className="fw-bold mx-2">Edt Procedure Codes</h3>
                <div className="d-flex">
                  <button
                    type="button"
              ...
              <div className="row mt-2">
                ...
                <div className="form-floating col-md-11">
                  <textarea
                    ...
                    id="description"
                    value={procedureDescription ? procedureDescription : ""}
                  ></textarea>
                </div>
              </div>
                  ...
                  <div className="card-body">
                    <div className="col-md-12 d-flex">
                      <input
                        ...
                        type="checkbox"
                        id="excludeCode"
                        checked={excludeCodevalue === 1 ? true : false}
                        onChange={() =>
                          setExcludceCode(!excludeCode == true ? 1 : 0)
                        }
                      />
                      <label
                    ...
                    <div className="col-md-12 d-flex mt-2">
                      <input
                        ...
                        type="checkbox"
                        id=""
                        checked={includeCodevalue === 1 ? true : false}
                        // Checked={includeCode == 1 ? true : false}
                        onChange={() =>
                          setInccludceCode(!includeCode == true ? 1 : 0)
                        }
                      />
                      <label
                        className="form-check-label mx-2 mt-1"
                        htmlFor="includeCode"
                      >
                        This is an all inclusiveeeeeeeeeeee code
                      </label>
                    </div>
                    <div className="col-md-12 d-flex mt-2">
                      <input
                        className="form-check-input fs-5"
                        type="checkbox"
                        checked={codePercentagevalue === 1 ? true : false}
                        id="codePercentage"
                        onChange={() =>
                          setCodePercentage(!codePercentage == true ? 1 : 0)
                        }
                      />
                      <label
                        className="form-check-label mx-2 mt-1"
                    ...
                    <div className="d-flex align-items-center mt-3">
                      ...
                      <div className="col-md-2 mx-2">
                        ...
                        <InputDecimal
                          precision={2}
                          value={defaultUnits ? defaultUnits : ""}
                          className="form-control form-control-sm"
                          id="defaultUnit"
                          autoComplete="off"
                          name="defaultUnit"
                    ...
                    <div className="col-md-12 d-flex mt-3 align-items-center">
                      <div className="col-md-12">
                        ...
                        <input
                          ...
                          className="form-control form-control-sm"
                          id="narrativeNotes"
                          value={narrativeNotes ? narrativeNotes : ""}
                            ...
                            <div className="">
                              <div className="input-group">
                                <input
                                  ...
                                  aria-label="Global1"
                                  id="Global1e"
                                  value={sendModifer1Code}
                                  onChange={(e) =>
                                    setSendModifer1Code(e.target.value)
                                  }
                                  name="Global1"
                                  autoComplete="off"
                                  autoCapitalize="off"
                            ...
                            <div className=" mx-2">
                              <div className="input-group">
                                <input
                                  ...
                                  onChange={(e) =>
                                    setSendModifer2Code(e.target.value)
                                  }
                                  aria-label="Global2"
                                  id="Global2"
                                  name="Global2"
                            ...
                            <div className=" mx-2">
                              <div className="input-group">
                                <input
                                  ...
                                  type="text"
                                  onChange={(e) =>
                                    setSendModifer3Code(e.target.value)
                                  }
                                  placeholder="Global 3"
                                  aria-label="Global3"
                                  id="Global3"
                                  name="Global3"
                                  value={sendModifer3Code}
                                  autoComplete="off"
                                  autoCapitalize="off"
                                  autoCorrect="off"
                                  spellCheck="false"
                            ...
                            <div className="mx-2">
                              <div className="input-group">
                                <input
                                  ...
                                  type="text"
                                  onChange={(e) =>
                                    setSendModifer4Code(e.target.value)
                                  }
                  ...
                  <p className="form-error">*{errors.practiceName}</p>
                    ...
                    <div className="col-md-12 mt-3">
                      ...
                      <input
                        ...
                        className="form-control form-control-sm"
                        id="addDescription"
                        value={addDescription ? addDescription : ""}
                ...
                {touched.practiceName && errors.practiceName ? (
                  <p className="form-error">*{errors.practiceName}</p>
                    ...
                    <div className="col-md-6 mt-3">
                      ...
                      <select
                        defaultValue={globalPeriod ? globalPeriod : ""}
                      ...
                      <div className="card mb-2">
                        ...
                        <div className="card-body ">
                          <div className="col-md-12">
                            <div className="col-md-12 d-flex mt-2">
                              <input
                                Checked={printSuperbillCode == 1 ? true : false}
                                onChange={() =>
                                  setPrintSuperbillCode(
                                    !printSuperbillCode == true ? 1 : 0
                                  )
                                }
                                className="form-check-input fs-5"
                                type="checkbox"
