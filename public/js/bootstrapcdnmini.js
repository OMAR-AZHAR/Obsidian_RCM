 ...
 * Any New version of Bootstrap (>5.2.2) can be replaced with the code below
 */
!(function (t, e) {
  ...
  function qt(t) {
    return (
      ...
      (t instanceof Ft(t).ShadowRoot || t instanceof ShadowRoot)
    );
  }
  const Rt = {
    name: 'applyStyles',
  ...
  function Gt(t, e, i) {
    ...
    var r = (Bt(t) ? Ft(t) : window).visualViewport,
      a = !Ut() && i,
  ...
  function oe(t) {
    for (var e = Ft(t), i = se(t); i && ee(i) && 'static' === te(i).position; ) i = se(i);
    ...
    if (c) {
      ...
      A === Ft(i) &&
        ...
        (s !== bt && ((s !== gt && s !== mt) || o !== At)) ||
          ((v = _t),
          (f -=
            (d && A === w && w.visualViewport ? w.visualViewport.width : A[T]) - n.width),
          (f *= l ? 1 : -1));
    }
    var C,
  ...
  function Le(t, e) {
    ...
    var i = e,
        ...
        var s =
            'clippingParents' === e
              ? (function (t) {
                  var e = Ce(ne(t)),
                    i =
                      ['absolute', 'fixed'].indexOf(te(t).position) >= 0 && zt(t)
                        ? oe(t)
                        : t;
                  return Bt(i)
                    ? e.filter(function (t) {
                        return Bt(t) && Zt(t, i) && 'body' !== Wt(t);
                      })
                    : [];
                })(t)
              : [].concat(e),
      ...
      })(Bt(y) ? y : y.contextElement || ie(t.elements.popper), l, h, r),
        ...
        h = {
          ...
          forceUpdate: function () {
            if (!c) {
              ...
              if (Fe(e, i)) {
                (a.rects = {
                  reference: He(e, oe(i), 'fixed' === a.options.strategy),
                  popper: Jt(i),
                }),
                  (a.reset = !1),
  ...
  var ze = Be(),
    qe = Be({ defaultModifiers: [me, je, pe, Rt] }),
    Re = Be({ defaultModifiers: [me, je, pe, Rt, Pe, De, Me, he, Ne] });
  ...
  class ci extends z {
    constructor(t, e) {
      super(t, e),
        ...
        (this._menu =
          Q.next(this._element, ti)[0] ||
          Q.prev(this._element, ti)[0] ||
          Q.findOne(ti, this._parent)),
    ...
    static dataApiKeydownHandler(t) {
      ...
      const s = this.matches(Je)
          ...
          : Q.prev(this, Je)[0] ||
            Q.next(this, Je)[0] ||
            Q.findOne(Je, t.delegateTarget.parentNode),
  ...
  class vi extends B {
    ...
    dispose() {
      this._isAppended &&
        (P.off(this._element, mi), this._element.remove(), (this._isAppended = !1));
    }
    _getElement() {
      if (!this._element) {
  ...
  class Ii extends z {
    ...
    show(t) {
      this._isShown ||
        ...
        P.trigger(this._element, Oi, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        (this._isTransitioning = !0),
  ...
  P.on(
    ...
    function (t) {
      ...
      const i = Q.findOne(Mi);
      i && i !== e && Bi.getInstance(i).hide(), Bi.getOrCreateInstance(e).toggle(this);
    },
  ),
    P.on(window, 'load.bs.offcanvas.data-api', () => {
      for (const t of Q.find(Mi)) Bi.getOrCreateInstance(t).show();
    }),
  ...
  const zi = new Set([
    ...
    Vi = (t, e) => {
      ...
      return e.includes(i)
        ? !zi.has(i) || Boolean(qi.test(t.nodeValue) || Ri.test(t.nodeValue))
  ...
  class ln extends z {
    ...
    hide() {
      ...
      if ((t.classList.remove(Zi), 'ontouchstart' in document.documentElement))
        for (const t of [].concat(...document.body.children)) P.off(t, 'mouseover', h);
  ...
  class _n extends z {
    ...
    _initializeTargetsAndObservables() {
      ...
      const t = Q.find(pn, this._config.target);
      for (const e of t) {
    ...
    _activateParents(t) {
      if (t.classList.contains('dropdown-item'))
        Q.findOne('.dropdown-toggle', t.closest('.dropdown')).classList.add(fn);
      else
  ...
  P.on(window, 'load.bs.scrollspy.data-api', () => {
    for (const t of Q.find('[data-bs-spy="scroll"]')) _n.getOrCreateInstance(t);
  }),
    g(_n);
  const bn = 'ArrowLeft',
    vn = 'ArrowRight',
  ...
  class xn extends z {
    ...
    _getInnerElement(t) {
      return t.matches(On) ? t : Q.findOne(On, t);
    }
    _getOuterElement(t) {
  ...
  class Nn extends z {
    ...
    show() {
      P.trigger(this._element, 'show.bs.toast').defaultPrevented ||
        ...
        d(this._element),
        this._element.classList.add(Ln, Dn),
        this._queueCallback(
          () => {
